...
//
///**
// * Created by suneelbelkhale1 on 3/19/16.
// */
//
//
...
//                if (sizes != null) {
//                    /* Select the size that fits surface considering maximum size allowed */
//                    Size frameSize = calculateCameraFrameSize(sizes, new JavaCameraSizeAccessor(), height, width); /////HEHEHEHEHE SUNEEL CHANGED THIS MWAHAHAHA
//
//
//                    params.setPreviewFormat(ImageFormat.NV21);
//                    Log.d(TAG, "Set preview size to " + Integer.valueOf((int)frameSize.width) + "x" + Integer.valueOf((int)frameSize.height));
...
//                    mFrameHeight = params.getPreviewSize().width;   //////THESE WERE CHANGED AS WELL HAHAH
//
//
//                    /**/
//                    int realWidth = mFrameHeight, realHeight = mFrameWidth;
//
...
//        public Mat gray() {
//            if (mRotated != null) mRotated.release();
//            mRotated = mYuvFrameData.submat(0, mHeight, 0, mWidth); //submit with reversed width and height because its done on the landscape frame
//
//            mRotated = mRotated.t();
//            Core.flip(mRotated, mRotated, 1);
//            return mRotated;
